...
define([], function() {
    ...
    return function(){
        ...
        function loadChartsJS(){
            ...
            if (typeof window.__ChartsJS_ChartsJSV1_0_1_beta4 === 'undefined' ) {
			 ...
			 */
                ...
                */
                ...
                this.options.scaleFontStyle,this.options.scaleFontFamily),lineWidth:this.options.scaleLineWidth,lineColor:this.options.scaleLineColor,gridLineWidth:this.options.scaleShowGridLines?this.options.scaleGridLineWidth:0,gridLineColor:this.options.scaleShowGridLines?this.options.scaleGridLineColor:"rgba(0,0,0,0)",padding:this.options.showScale?0:this.options.barShowStroke?this.options.barStrokeWidth:0,showLabels:this.options.scaleShowLabels,display:this.options.showScale};this.options.scaleOverride&&c.extend(b,
                {calculateYRange:c.noop,steps:this.options.scaleSteps,stepValue:this.options.scaleStepWidth,min:this.options.scaleStartValue,max:this.options.scaleStartValue+this.options.scaleSteps*this.options.scaleStepWidth});this.scale=new this.ScaleClass(b)},addData:function(b,d){c.each(b,function(a,b){c.isNumber(a)&&this.datasets[b].bars.push(new this.BarClass({value:a,label:d,x:this.scale.calculateBarX(this.scale.valuesCount+1),y:this.scale.endPoint,width:this.scale.calculateBarWidth(this.datasets.length),
                base:this.scale.endPoint,strokeColor:this.datasets[b].strokeColor,fillColor:this.datasets[b].fillColor}))},this);this.scale.addXLabel(d);this.update()},removeData:function(){this.scale.removeXLabel();c.each(this.datasets,function(b){b.bars.shift()},this);this.update()},reflow:function(){c.extend(this.BarClass.prototype,{y:this.scale.endPoint,base:this.scale.endPoint});var b=c.extend({height:this.chart.height,width:this.chart.width});this.scale.update(b)},draw:function(b){var d=b||1;this.clear();this.scale.draw(d);
                c.each(this.datasets,function(a,b){c.each(a.bars,function(a,c){var e=this.scale.calculateBarY(this.datasets,b,c,a.value),g=this.scale.calculateBarHeight(this.datasets,b,c,a.value);a.transition({base:this.scale.endPoint-(Math.abs(g)-Math.abs(e)),x:this.scale.calculateBarX(c),y:Math.abs(e),height:Math.abs(g),width:this.scale.calculateBarWidth(this.datasets.length)},d).draw()},this)},this)}})}).call(this);

                window.__ChartsJS_ChartsJSV1_0_1_beta4 = window.Chart;
            }

            return window.__ChartsJS_ChartsJSV1_0_1_beta4;
